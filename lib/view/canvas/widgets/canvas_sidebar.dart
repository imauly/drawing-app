...
import 'package:drawing_app/view/canvas/widgets/palette.dart';
...
class CanvasSideBar extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      width: 300,
      height: MediaQuery.of(context).size.height < 680 ? 350 : 510,
      decoration: BoxDecoration(
        color: ui.Color.fromARGB(255, 185, 208, 247),
        borderRadius: const BorderRadius.horizontal(right: Radius.circular(10)),
        boxShadow: [
          BoxShadow(
            color: ui.Color.fromARGB(255, 63, 63, 63),
            blurRadius: 3,
                    ...
                    children: [
                      Container(
                        ...
                        color: drawingMode.value == DrawingMode.line
                            ? Colors.grey[900]
                            : ui.Color.fromARGB(255, 63, 63, 63),
                      ),
                    ],
                  ),
                ),
              ...
              children: [
                IconButton(
                  onPressed: allSketches.value.isNotEmpty
                      ...
                      : null,
                  icon: const Icon(Icons.undo), color: ui.Color.fromARGB(255, 254, 255, 255),
                ),
        ...
        child: Container(
          ...
          child: Tooltip(
            ...
            child: child ??
                Icon(
                  iconData,
                  color: selected ? ui.Color.fromARGB(255, 5, 5, 5) : const ui.Color.fromARGB(255, 57, 56, 56),
                  size: 20,
                ),
          ),
        ),
